...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="sidebar w-[220px] flex-shrink-0 h-full flex flex-col p-4">
        ...
        <nav class="flex-1 space-y-1">
            ...
            <a href="index.php" class="nav-link active"><span class="icon"><i class="bi bi-paw"></i></span> Fauna <span class="badge"><?= $total_fauna ?></span></a>
    ...
    <main class="flex-1 overflow-y-auto p-6 md:p-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 animate-in delay-1">
            <div>
                <p class="text-sm text-[#8a7e72] font-medium"><i class="bi bi-paw"></i> Manajemen Satwa</p>
        ...
        <div class="card-grid animate-in delay-3">
            <div class="empty-state">
                <span class="icon"><i class="bi bi-paw"></i></span>
            ...
            <div class="fauna-card animate-in <?= $delay ?>">
                ...
                <div class="body">
                    <div class="flex items-start justify-between gap-2">
                        ...
                        <span class="badge-lokasi text-xs whitespace-nowrap"><i class="bi bi-geo-alt"></i> <?= htmlspecialchars($fauna['lokasi']) ?></span>
                        <?php endif; ?>
                    </div>
