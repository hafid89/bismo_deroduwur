        ...
        <div class="p-8">
            ...
            <form method="POST" action="" enctype="multipart/form-data" class="bg-white rounded-xl shadow-lg p-8">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="tanggal" value="<?= date('Y-m-d') ?>" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-[#2F5233] focus:outline-none focus:ring-2 focus:ring-[#2F5233] transition duration-300" required>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="isi" rows="10" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-[#2F5233] focus:outline-none focus:ring-2 focus:ring-[#2F5233] transition duration-300" required></textarea>
                </div>
