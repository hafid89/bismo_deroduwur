...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="sidebar w-[220px] flex-shrink-0 h-full flex flex-col p-4">
        ...
        <nav class="flex-1 space-y-1">
            ...
            <a href="index.php" class="nav-link active"><span class="icon"><i class="bi bi-image"></i></span> Galeri <span class="badge"><?= $total ?></span></a>
    ...
    <main class="flex-1 overflow-y-auto p-6 md:p-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 animate-in delay-1">
            <div>
                <p class="text-sm text-[#8a7e72] font-medium"><i class="bi bi-image"></i> Manajemen Media</p>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
            ...
            <div class="stat-card animate-in delay-5">
                <p class="label"><i class="bi bi-folder"></i> Kategori</p>
