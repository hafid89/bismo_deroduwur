...
<nav class="fixed w-full z-50 transition-all duration-300" id="navbar">
    <div class="w-full px-4 lg:px-8">
        <div class="flex items-center h-16 md:h-20">
            ...
            <!-- Navbar Desktop -->
            <div class="hidden xl:flex items-center space-x-6 2xl:space-x-8 text-lg flex-1 relative">
                <div class="flex items-center justify-center space-x-6 2xl:space-x-8 w-full pr-36">
                ...
                <!-- Tombol WA -->
                <a href="https://wa.me/6281390195488" target="_blank" class="absolute right-0 bg-sunrise hover:bg-sunrise-dark text-white px-4 py-1.5 2xl:px-5 2xl:py-2 rounded-full transition duration-300 font-medium whitespace-nowrap shadow-sm text-xs 2xl:text-sm">
                    Hubungi via WA
                </a>
            </div>
        ...
        <div id="mobileMenu" class="hidden xl:hidden pb-4 max-h-[80vh] overflow-y-auto">
            ...
            <div class="space-y-1">
                <a href="<?= BASE_URL ?>" class="block py-2.5 px-3 rounded-lg <?= $current_page == 'index.php' ? 'text-[#E0BE45] font-bold bg-white/10' : 'text-white hover:bg-white/10' ?> transition duration-200 text-sm">Beranda</a>
                <a href="<?= BASE_URL ?>kisah.php" class="block py-2.5 px-3 rounded-lg <?= $current_page == 'kisah.php' ? 'text-[#E0BE45] font-bold bg-white/10' : 'text-white hover:bg-white/10' ?> transition duration-200 text-sm">Kisah Kami</a>
                <a href="<?= BASE_URL ?>jalur.php" class="block py-2.5 px-3 rounded-lg <?= $current_page == 'jalur.php' ? 'text-[#E0BE45] font-bold bg-white/10' : 'text-white hover:bg-white/10' ?> transition duration-200 text-sm">Telusur Jalur</a>
                <a href="<?= BASE_URL ?>peraturan.php" class="block py-2.5 px-3 rounded-lg <?= $current_page == 'peraturan.php' ? 'text-[#E0BE45] font-bold bg-white/10' : 'text-white hover:bg-white/10' ?> transition duration-200 text-sm">Siap Mendaki</a>
                ...
                <div class="pl-4 border-l-2 border-white/20 ml-3 mt-1">
                    ...
                    <a href="<?= BASE_URL ?>alam.php" class="block py-2 px-3 rounded-lg <?= $current_page == 'alam.php' ? 'text-[#E0BE45] font-bold bg-white/10' : 'text-white/80 hover:bg-white/10' ?> transition duration-200 text-sm">Semua</a>
                    <a href="<?= BASE_URL ?>alam.php#flora" class="block py-2 px-3 rounded-lg text-white/80 hover:bg-white/10 transition duration-200 text-sm">Flora</a>
                    <a href="<?= BASE_URL ?>alam.php#fauna" class="block py-2 px-3 rounded-lg text-white/80 hover:bg-white/10 transition duration-200 text-sm">Fauna</a>
                </div>
                ...
                <div class="pl-4 border-l-2 border-white/20 ml-3 mt-2">
                    ...
                    <a href="<?= BASE_URL ?>galeri.php" class="block py-2 px-3 rounded-lg <?= $current_page == 'galeri.php' ? 'text-[#E0BE45] font-bold bg-white/10' : 'text-white/80 hover:bg-white/10' ?> transition duration-200 text-sm">Semua</a>
                    <a href="<?= BASE_URL ?>galeri.php?filter=jalur" class="block py-2 px-3 rounded-lg text-white/80 hover:bg-white/10 transition duration-200 text-sm">Jalur</a>
                    <a href="<?= BASE_URL ?>galeri.php?filter=ekosistem" class="block py-2 px-3 rounded-lg text-white/80 hover:bg-white/10 transition duration-200 text-sm">Ekosistem</a>
...
<style>
    ...
    .bg-forest-light .navbar-dropdown-menu {
        background: #418B24;
